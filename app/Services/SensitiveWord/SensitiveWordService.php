...
class SensitiveWordService {
    ...
    {
        $this->words_file = base_path('public/sensitive/sensitive_words_jEzvreWbeci2KNK6.txt')  ?? '';
        $this->root = new SensitiveWordNodeService();
    ...
    public function addWord($word)
    {
        ...
        for ($i = 0; $i < strlen($word); $i++) {
            ...
            if (!isset($node->children[$char])) {
                $node->children[$char] = new SensitiveWordNodeService();
            }
